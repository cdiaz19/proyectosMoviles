		...
		<input type="hidden" name="action" value="edit" /> 
			...
			<tr>
				<td class="l">Cedula : </td>
                                <td class="r"><input type="text" name="cedula" value="<%= profesorList.get(0).getUsuario().getCedula() %>"/></td>
			</tr>
			<tr>
				<td class="l">Nombre : </td>
				<td class="r"><input type="text" name="nombre" value="<%= profesorList.get(0).getNombre() %>"/></td>
			</tr>
                        <tr>
				<td class="l">Telefono : </td>
				<td class="r"><input type="text" name="telefono" value="<%= profesorList.get(0).getTelefono() %>"/></td>
			</tr>
                         <tr>
				<td class="l">Correo : </td>
				<td class="r"><input type="email" name="correo" value="<%= profesorList.get(0).getCorreo() %>"/></td>
			</tr>
                        <tr>
				<td class="l">Contrasena : </td>
				<td class="r"><input type="password" name="contrasena" value="<%= profesorList.get(0).getUsuario().getContrasena() %>"/></td>
			</tr>
			<tr>
