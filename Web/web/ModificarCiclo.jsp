    ...
    <body>
        ...
        <form method="POST" action="ServletCiclo" name="modifica">
            ...
            <table class="tableModifier">
                ...
                <tr>
                    <td class="l">Anno : </td>
                    <td class="r"><input type="text" name="anno" value="<%= cicloList.get(0).getAnno()%>" required/></td>
                </tr>
                <tr>
                    <td class="l">Numero : </td>
                    <td class="r"><input type="text" name="numero" value="<%= cicloList.get(0).getNumero()%>" required/></td>
                </tr>
                <tr>
                    <td class="l">Fecha Inicio : </td>
                    <td class="r"><input type="date" name="fechaInicio" value="<%= cicloList.get(0).getFechaInicio()%>" required/></td>
                </tr>
                <tr>
                    <td class="l">Fecha Final : </td>
                    <td class="r"><input type="date" name="fechaFin" value="<%= cicloList.get(0).getFechaFinal()%>" required/></td>
                </tr>
