        ...
        <form method="POST" action="ServletCarrera" name="modifica">
            ...
            <table class="tableModifier">
                ...
                <tr>
                    ...
                    <td class="r"><input type="text" name="codigo" value="<%= carreraList.get(0).getCodigo()%>" required/></td>
                </tr>
                <tr>
                    <td class="l">Nombre : </td>
                    <td class="r"><input type="text" name="nombre" value="<%= carreraList.get(0).getNombre()%>" required/></td>
                </tr>
                <tr>
                    <td class="l">Titulo : </td>
                    <td class="r"><input type="text" name="titulo" value="<%= carreraList.get(0).getTitulo()%>" required/></td>
                </tr>
                <tr>
