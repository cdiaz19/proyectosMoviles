...
public class AdmClienteActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener, ProfesorAdapter.ProfesorAdapterListener {
    ...
    public void onContactSelected(Profesor profesor) { //TODO get the select item of recycleView
        Toast.makeText(getApplicationContext(), "Cliente Seleccionado: " + profesor.getCedula() + ", " + profesor.getNombre(), Toast.LENGTH_LONG).show();
    }
