...
public class AdmVideoJuegoActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener, VideoJuegoAdapter.VideoJuegoAdapterListener {

    private RecyclerView mRecyclerView;
    private VideoJuegoAdapter mAdapter;
    private List<VideoJuego> categoriaList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //toolbar fancy stuff
        getSupportActionBar().setTitle("Video Juegos");

        mRecyclerView = findViewById(R.id.recycler_carrerasFld);
        categoriaList = new ArrayList<>();
        model = new ModelData();
        categoriaList = model.getVideoJuegoList();
        mAdapter = new VideoJuegoAdapter(categoriaList, this);
    ...
    private void checkIntentInformation() {
        ...
        if (extras != null) {
            ...
            if (aux == null) {
                aux = (VideoJuego) getIntent().getSerializableExtra("editCarrera");
                if (aux != null) {
                    //found an item that can be updated
                    boolean founded = false;
                    for (VideoJuego categoria : categoriaList) {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        if (direction == ItemTouchHelper.START) {
            if (viewHolder instanceof VideoJuegoAdapter.MyViewHolder) {
    ...
    @Override
    public void onContactSelected(VideoJuego categoria) { //TODO get the select item of recycleView
        Toast.makeText(getApplicationContext(), "Seleccciono VideoJuego: " + categoria.getCodigo() + ", " + categoria.getNombre(), Toast.LENGTH_LONG).show();
    }
}
