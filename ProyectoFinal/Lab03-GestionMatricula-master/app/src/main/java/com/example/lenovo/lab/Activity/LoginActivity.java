...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private ArrayList<Usuario> searchUsers() {
        ...
        //administrador
        usuariosList.add(new Usuario("@admin", "admin", "administrador", "111"));
        //matriculador
        usuariosList.add(new Usuario("@matric", "matric", "matriculador", "222"));
        //profesor
        usuariosList.add(new Usuario("@profe", "profe", "profesor", "444"));
        //alumno
        usuariosList.add(new Usuario("@estud", "estud", "estudiante", "333"));
        return usuariosList;
    }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (Usuario user : searchUsers()) {
                if (user.getCorreo().equals(mEmail)) {
                    // Account exists, return true if the password matches.
                    usuario = user;
                    return usuario.getContraseña().equals(mPassword);
                }
            }
