...
public class ClientAdapter extends RecyclerView.Adapter<ClientAdapter.MyViewHolder> implements Filterable {
    ...
    public ClientAdapter(List<Client> clientList, AlumnoAdapterListener listener) {
    ...
    public void onBindViewHolder(ClientAdapter.MyViewHolder holder, int position) {
        ...
        holder.titulo1.setText(client.getIdentify());
        holder.titulo2.setText(client.getName());
    }
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Client row : clientList) {
                        ...
                        if (row.getIdentify().toLowerCase().contains(charString.toLowerCase()) || row.getName().toLowerCase().contains(charString.toLowerCase())) {
