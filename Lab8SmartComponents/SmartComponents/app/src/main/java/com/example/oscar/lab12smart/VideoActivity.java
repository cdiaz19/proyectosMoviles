        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            btnRec.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    /**
                     * Llamamos el m�todo que configura el media recorder y le decimos el archivo de salida
                     */
                    prepareRecorder();
                    mediaRecorder.setOutputFile(fileName);
                    try {
                        /**
                         * Una vez configurado todo llamamos al m�todo prepare que deja todo listo
