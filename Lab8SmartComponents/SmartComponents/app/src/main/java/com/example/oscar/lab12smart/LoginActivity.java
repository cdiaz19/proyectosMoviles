    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registro.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //   Intent intentRegistro = new Intent(LoginActivity.this, UsuarioActivity.class);
    ...
    private void Login() {
      ...
      /*  final ProgressDialog progressDialog = new ProgressDialog(LoginActivity.this,
        ...
        if(email.equals("admin@admin.com") && password.equals("1234")){
            ...
            Toast.makeText(getBaseContext(), "Error!! Usuario no registrado!!", Toast.LENGTH_LONG).show();
        }
    }
